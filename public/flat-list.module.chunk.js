...
var FlatListComponent = (function () {
    function FlatListComponent(http, router, toasterService, _formBuilder) {
        this.http = http;
        this.router = router;
        this._formBuilder = _formBuilder;
        this.displayedColumns = ['select', 'block', 'flat_no', 'floor', 'owner_name', 'owner_contact', 'flat_status', 'details'];
    ...
    FlatListComponent.prototype.getFlatOwnerId = function (flatowner) {
