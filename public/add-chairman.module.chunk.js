...
var AddChairmanComponent = (function () {
    function AddChairmanComponent(http, dialog, toasterService, _formBuilder) {
        ...
        this.displayedColumns = ['select', 'manager', 'name', 'email', 'contact', 'chairman_status', 'actions'];
    ...
    AddChairmanComponent.prototype.changeStatus = function (chairman, id) {
        var _this = this;
        chairman = !chairman;
    ...
    AddChairmanComponent.prototype.openEditDialog = function (chairman_id) {
        var _this = this;
        console.log(chairman_id);
        var dialogRef = this.dialog.open(EditDialogComponent, {
            height: '360px',
            width: '260px',
            data: { chairman_id: chairman_id },
        });
        dialogRef.afterClosed().subscribe(function (result) {
            console.log('The dialog was closed');
            console.log(result);
...
var EditDialogComponent = (function () {
    ...
    EditDialogComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get('api/chairman/' + this.data.chairman_id).subscribe(function (data) {
            _this.chairman = data;
            _this.chairman_name = _this.chairman.chairman_name;
            _this.contact = _this.chairman.contact;
            console.log(_this.chairman);
        });
    };
    ...
    EditDialogComponent.prototype.onSubmitClick = function () {
        var _this = this;
        console.log(this.chairman_name, this.contact);
        var update_data = {
            chairman_name: this.chairman_name,
            contact: this.contact
        };
        console.log(update_data);
        this.http.put('api/updatechairman/' + this.chairman._id, update_data).subscribe(function (data) {
            _this.response = data;
            if (_this.response.success == true) {
                _this.toasterService.pop('success', _this.response.message);
            }
...
var AddChairmanModule = (function () {
    ...
    AddChairmanModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            entryComponents: [__WEBPACK_IMPORTED_MODULE_2__add_chairman_component__["c" /* TestDialogComponent */], __WEBPACK_IMPORTED_MODULE_2__add_chairman_component__["b" /* EditDialogComponent */]],
            declarations: [__WEBPACK_IMPORTED_MODULE_2__add_chairman_component__["a" /* AddChairmanComponent */], __WEBPACK_IMPORTED_MODULE_2__add_chairman_component__["c" /* TestDialogComponent */], __WEBPACK_IMPORTED_MODULE_2__add_chairman_component__["b" /* EditDialogComponent */]]
        })
    ], AddChairmanModule);
