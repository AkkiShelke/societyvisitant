...
var AddChairmanComponent = (function () {
    function AddChairmanComponent(dialog) {
        this.dialog = dialog;
        this.displayedColumns = ['select', 'id', 'block', 'manager', 'name', 'email', 'contact'];
    ...
    AddChairmanComponent.prototype.openMe = function () {
     ...
     */
    AddChairmanComponent.prototype.ngAfterViewInit = function () {
...
function createNewUser(id) {
    ...
    var manager = MANAGER[Math.round(Math.random() * (MANAGER.length - 1))];
...
var MANAGER = ['Maia', 'Asher', 'Olivia'];
var NAMES = ['Ramesh', 'Vishal', 'Shubham', 'Viraj', 'Vikram'];
