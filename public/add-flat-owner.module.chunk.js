            ...
            if (_this.flatresponse.success == true) {
                ...
                _this.http.post('api/addflatowner', flatowner_details).subscribe(function (data) {
                    ...
                    if (_this.flatownerresponse.success == true) {
                            ...
                            for (var i = 0; _this.row.length > i; i++) {
                                ...
                                _this.http.post('api/addflatmember', member_details).subscribe(function (data) {
                                    ...
                                    if (_this.memberresponse.success == true) {
                                        _this.toasterService.pop('success', "Flat Details enter Successfully");
                                        setTimeout(function () {
                                            _this.router.navigate(['/society_details']);
                                        }, 3000);
                                    }
                                    else {
                                        _this.toasterService.pop('error', _this.memberresponse.message);
                        ...
                        var flat_details_1 = {
                            chairman_id: _this.chairman_id,
                            flat_no: _this.flatno,
                        };
                        _this.http.post('api/checkflat', flat_details_1).subscribe(function (data) {
                            console.log(data);
                            var result = data;
                            var flat_id = result.result._id;
                            console.log(flat_id);
                            _this.http.delete('api/deleteflat/' + flat_id).subscribe(function (data) {
                                _this.memberresponse = data;
                                console.log(data);
                            });
                        });
    ...
    AddFlatOwnerModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__angular_material__["o" /* MatRadioModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_6__angular_material__["f" /* MatCheckboxModule */],
                __WEBPACK_IMPORTED_MODULE_6__angular_material__["w" /* MatTooltipModule */],
                __WEBPACK_IMPORTED_MODULE_6__angular_material__["q" /* MatSlideToggleModule */],
                __WEBPACK_IMPORTED_MODULE_6__angular_material__["v" /* MatTableModule */],
