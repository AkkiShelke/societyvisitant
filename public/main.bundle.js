...
var map = {
	...
	"./chairman-list/chairman-list.module": [
		"../../../../../src/app/layout/chairman-list/chairman-list.module.ts",
		"common",
		"chairman-list.module"
	],
	...
	"./manager-list/manager-list.module": [
	...
	"./security-list/security-list.module": [
...
var routes = [
    ...
    { path: '**', redirectTo: 'Please Check the URL' }
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_angular5_toaster__ = __webpack_require__("../../../../angular5-toaster/dist/bundles/angular5-toaster.umd.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_angular5_toaster___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_angular5_toaster__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
