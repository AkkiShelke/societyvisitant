...
var DashboardComponent = (function () {
    function DashboardComponent(http, router, _formBuilder) {
        this.http = http;
        this.router = router;
