...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_chart_js__ = __webpack_require__("../../../../chart.js/src/chart.js");
...
}(__WEBPACK_IMPORTED_MODULE_2__angular_material__["x" /* NativeDateAdapter */]));
...
var DashboardComponent = (function () {
    function DashboardComponent(http, router, toasterService, _formBuilder) {
        ...
        this.till_date = new Date();
        this.visitorchart = []; // This will hold our chart info
        this.flatchart = []; // This will hold our chart info
        this.securitychart = []; // This will hold our chart info
    ...
    DashboardComponent.prototype.getListOfSecurity = function () {
        ...
        this.http.get('api/securitylistdetails/' + this.societyadmin.id).subscribe(function (data) {
            ...
            var secuirtylist = data;
            var list = [secuirtylist.length];
            var labels = ["Total Security"];
            var colors = ["#1E90FF"];
            // Doughnut
            __WEBPACK_IMPORTED_MODULE_8_chart_js__["Chart"].pluginService.register({
            ...
            _this.securitychart = new __WEBPACK_IMPORTED_MODULE_8_chart_js__["Chart"](ctx, config);
        });
    };
    DashboardComponent.prototype.getListOfFlat = function () {
        var _this = this;
        this.http.get('api/flatlistdetails/' + this.societyadmin.id).subscribe(function (data) {
            var flat = data;
            var list = [flat.length];
            var labels = ["Total Flat"];
            var colors = ["#00FF7F"];
            // Doughnut
            __WEBPACK_IMPORTED_MODULE_8_chart_js__["Chart"].pluginService.register({
                beforeDraw: function (chart) {
            ...
            _this.flatchart = new __WEBPACK_IMPORTED_MODULE_8_chart_js__["Chart"](ctx, config);
        });
    };
    DashboardComponent.prototype.getFlatownerData = function () {
        ...
        this.http.get('api/flatownerlistdetails/' + this.societyadmin.id).subscribe(function (data) {
            ...
            _this.dataSource = new __WEBPACK_IMPORTED_MODULE_2__angular_material__["u" /* MatTableDataSource */](_this.flatdetails);
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        setTimeout(function () {
            _this.getListOfVisitor();
        }, 400);
        setTimeout(function () {
            _this.getListOfFlat();
        }, 700);
        setTimeout(function () {
            _this.getListOfSecurity();
        }, 1000);
    ...
    DashboardComponent.prototype.getListOfVisitor = function () {
        var _this = this;
        var pass_date = {};
        this.http.post('api/visitorbysociety/' + this.societyadmin.id, pass_date).subscribe(function (data) {
            console.log(data);
            var visitor = data;
            var list = [visitor.length];
            var labels = ["Daily Visitor"];
            var colors = ["#ff3333"];
            // Doughnut
            __WEBPACK_IMPORTED_MODULE_8_chart_js__["Chart"].pluginService.register({
                beforeDraw: function (chart) {
            ...
            _this.visitorchart = new __WEBPACK_IMPORTED_MODULE_8_chart_js__["Chart"](ctx, config);
        });
    };
    ...
    DashboardComponent.prototype.printdate = function (event) {
        console.log("Print picker :-");
    };
    ;
    ...
    DashboardModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_4__angular_material__["l" /* MatNativeDateModule */]
            ],
            declarations: [
