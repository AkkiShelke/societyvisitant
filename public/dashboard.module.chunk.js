...
var DashboardComponent = (function () {
    function DashboardComponent(http, router, _formBuilder) {
        ...
        this.displayedColumns = ['select', 'block', 'flat_no', 'floor', 'owner_name', 'flat_status', 'owner_contact', 'actions'];
    ...
    DashboardComponent.prototype.getFlatownerData = function () {
        ...
        this.http.get('api/flatownerlistdetails/' + this.societyadmin.id).subscribe(function (data) {
            ...
            _this.count = _this.flatdetails.length;
